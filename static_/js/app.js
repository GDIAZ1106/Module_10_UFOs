...
function updateFilters() {
  ...
  // OPTION SUGGESTED BY THE INSTRUCTOR
    // // 4a. Save the element that was changed as a variable.
    // let changedElement = d3.select("this");

    // // 4b. Save the value that was changed as a variable.
    // let elementValue = changeElement.attr("value");
    ...
    // 5. If a filter value was entered then to the filters list. Otherwise, clear that filter from the filters object.
